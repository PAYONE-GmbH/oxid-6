...
$aLang = array(
    ...
    'FCPO_PAYOLUTION_MODE'                             => 'Unzer im Testmodus betreiben',
    'FCPO_PAYOLUTION_AUTH_USER'                        => 'Unzer Benutzername',
    ...
    'FCPO_PAYOLUTION_AUTH_SECRET'                      => 'Unzer Passwort',
    ...
    'FCPO_HELP_APPLE_PAY_MERCHANT_ID'                  => "Der Identifier Ihrer Apple Pay Merchant ID aus dem Apple Developer Portal, z. B. merchant.de.ihredomain.shop. Sie finden ihn unter Certificates, Identifiers & Profiles → Identifiers → Merchant IDs. Nicht zu verwechseln mit Ihrer PAYONE Händler-ID (MID).",
    'FCPO_APPLE_PAY_MERCHANT_ID'                       => "Apple Pay Merchant ID",
    'FCPO_HELP_APPLE_PAY_CERTIFICATE'                  => "In diesem Textfeld wird der Dateiname des Zertifikats festgelegt. Sie können einen beliebigen Namen vergeben. Bleibt das Feld beim Speichern leer, wird der ursprüngliche Name der hochgeladenen Datei übernommen. Sie können das Feld außerdem nutzen, um eine bereits auf dem Server vorhandene Zertifikatsdatei umzubenennen, ohne eine neue Datei hochzuladen.",
...
- Trifft keiner der genannten Fälle zu und ist das Feld leer, wird ein leerer Wert verwendet.",
    'FCPO_APPLE_PAY_KEY'                               => "Datei für den privaten Zertifikatsschlüssel",
    'FCPO_HELP_APPLE_PAY_KEY_TEXT'                     => "Inhalt des Schlüssels, falls keine Datei bereitgestellt wird. Werden beide Optionen genutzt, hat die hochgeladene Datei Vorrang!",
    'FCPO_APPLE_PAY_KEY_TEXT'                          => "Inhalt des privaten Schlüssels",
    ...
    'FCPO_HELP_GOOGLEPAY_GOOGLEMERCHANTNAME'             => 'Google Pay Merchant Name',
    'FCPO_GOOGLEPAY_GOOGLEMERCHANTNAME'                 => 'Google Pay Merchant Name',
    ...
    'FCPO_GOOGLEPAY_ALLOW_MASTERCARD'                   => 'Master Card f&uuml;r Google Pay erlauben',
    'FCPO_HELP_GOOGLEPAY_ALLOW_PREPAIDCARDS'            => 'Pre-Paid Karten f&uuml;r Google Pay erlauben',
    'FCPO_GOOGLEPAY_ALLOW_PREPAIDCARDS'                 => 'Pre-Paid Karten f&uuml;r Google Pay erlauben',
    'FCPO_HELP_GOOGLEPAY_ALLOW_CREDITCARDS'             => 'Kreditkarten f&uuml;r Google Pay erlauben',
    'FCPO_GOOGLEPAY_ALLOW_CREDITCARDS'                  => 'Kreditkarten f&uuml;r Google Pay erlauben',
    'FCPO_HELP_GOOGLEPAY_COUNTRYCODE'                   => 'Google Pay L&auml;nderk&uuml;rzel',
    'FCPO_GOOGLEPAY_COUNTRYCODE'                        => 'Google Pay L&auml;nderk&uuml;rzel',
    'FCPO_GOOGLEPAY_BUTTONCOLOR_DEFAULT'                => 'Standard',
    'FCPO_GOOGLEPAY_BUTTONCOLOR_WHITE'                  => 'Weiss',
    'FCPO_GOOGLEPAY_BUTTONCOLOR_BLACK'                  => 'Schwarz',
    'FCPO_HELP_GOOGLEPAY_BUTTONCOLOR'                   => 'Google Pay Button Farbe',
    'FCPO_GOOGLEPAY_BUTTONCOLOR'                        => 'Google Pay Button Farbe',
    'FCPO_GOOGLEPAY_BUTTONTYPE_BUY'                     => 'Kaufen Button',
    'FCPO_GOOGLEPAY_BUTTONTYPE_CHECKOUT'                => 'Checkout Button',
    'FCPO_GOOGLEPAY_BUTTONTYPE_ORDER'                   => 'Bestellen Button',
    'FCPO_GOOGLEPAY_BUTTONTYPE_PAY'                     => 'Bezahlen Button',
    'FCPO_GOOGLEPAY_BUTTONTYPE_PLAIN'                   => 'Schlichter Button',
    'FCPO_HELP_GOOGLEPAY_BUTTONTYPE'                    => 'Google Pay Button Typ',
    'FCPO_GOOGLEPAY_BUTTONTYPE'                         => 'Google Pay Button Typ',
);
