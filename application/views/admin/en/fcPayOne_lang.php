...
$aLang = array(
    ...
    'FCPO_PAYOLUTION_B2BMODE'          => 'Activate Unzer B2B-Mode',
    ...
    'FCPO_PAYOLUTION_MODE'             => 'Enable Unzer test mode',
    'FCPO_PAYOLUTION_AUTH_USER'        => 'Unzer User name',
    'FCPO_HELP_PAYOLUTION_AUTH_USER'   => 'User name for Authentification',
    'FCPO_PAYOLUTION_AUTH_SECRET'      => 'Unzer Password',
    ...
    'FCPO_HELP_APPLE_PAY_KEY'                          => "Field to upload a file containing the key.<br/><br/>
The text field is used to name the destination file, or path to an existing key file on server.<br/>
...
- If empty while not doing any of those, it will take an empty value.",
    'FCPO_APPLE_PAY_KEY'                               => "Certificate private key file",
    'FCPO_HELP_APPLE_PAY_KEY_TEXT'                     => "Content of the key, if no file provided. Priority goes to uploaded file if both options are used !",
    'FCPO_APPLE_PAY_KEY_TEXT'                          => "Content of private key",
    ...
    'FCPO_GOOGLEPAY_ALLOW_MASTERCARD'                   => 'Allow MasterCard for Google Pay',
    'FCPO_HELP_GOOGLEPAY_ALLOW_PREPAIDCARDS'            => 'Allow Pre-Paid cards for Google Pay',
    'FCPO_GOOGLEPAY_ALLOW_PREPAIDCARDS'                 => 'Allow Pre-Paid cards for Google Pay',
    'FCPO_HELP_GOOGLEPAY_ALLOW_CREDITCARDS'             => 'Allow Credit cards for Google Pay',
    'FCPO_GOOGLEPAY_ALLOW_CREDITCARDS'                  => 'Allow Credit cards for Google Pay',
    'FCPO_HELP_GOOGLEPAY_COUNTRYCODE'                   => 'Google Pay country code',
    'FCPO_GOOGLEPAY_COUNTRYCODE'                        => 'Google Pay country code',
    'FCPO_GOOGLEPAY_BUTTONCOLOR_DEFAULT'                => 'default',
    'FCPO_GOOGLEPAY_BUTTONCOLOR_WHITE'                  => 'white',
    'FCPO_GOOGLEPAY_BUTTONCOLOR_BLACK'                  => 'black',
    'FCPO_HELP_GOOGLEPAY_BUTTONCOLOR'                   => 'Google Pay button color',
    'FCPO_GOOGLEPAY_BUTTONCOLOR'                        => 'Google Pay button color',
    'FCPO_GOOGLEPAY_BUTTONTYPE_BUY'                     => 'Buy button',
    'FCPO_GOOGLEPAY_BUTTONTYPE_CHECKOUT'                => 'Checkout button',
    'FCPO_GOOGLEPAY_BUTTONTYPE_ORDER'                   => 'Order button',
    'FCPO_GOOGLEPAY_BUTTONTYPE_PAY'                     => 'Pay button',
    'FCPO_GOOGLEPAY_BUTTONTYPE_PLAIN'                   => 'Plain button',
    'FCPO_HELP_GOOGLEPAY_BUTTONTYPE'                    => 'Google Pay button type',
    'FCPO_GOOGLEPAY_BUTTONTYPE'                         => 'Google Pay button type',
);
