                        ...
                        <table border="1" cellpadding="4">
                            ...
                            [{foreach from=$edit->fcpoGetForwardRedirects() item='oForwardRedirect'}]
                                <tr style="border: 1px solid #C8C8C8;">
                                    ...
                                    <td style="background:[{if $oForwardRedirect->fulfilled}]green[{else}]red[{/if}];">
                                        [{if $oForwardRedirect->fulfilled}]
                                            [{oxmultilang ident="FCPO_FORWARD_REDIRECT_FULFILLED_YES"}]
                                        [{else}]
                            ...
                            <tr>
                                <td colspan="5" align="center">
                                    <input type="submit" value="[{oxmultilang ident="FCPO_FORWARD_REDIRECT_TRIGGER"}]">
                                </td>
                            </tr>
                        </table>
                    </form>
