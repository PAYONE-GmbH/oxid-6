<dl>
    ...
    <dd class="[{if $oView->getCheckedPaymentId() == $paymentmethod->oxpayments__oxid->value}]activePayment[{/if}]">
        ...
        [{if $oView->fcpoBNPLShowFon($sPaymentID)}]
            <li>
                <label for="fcpopl_secdebitnote_fon" class="req control-label col-lg-3">[{oxmultilang ident="FCPO_BNPL_FON"}]:</label>
                <div class="col-lg-9">
        ...
        [{/if}]
            <li>
                <label for="fcpopl_secdebitnote_iban" class="req control-label col-lg-3">[{oxmultilang ident="FCPO_BANK_IBAN"}]:</label>
                <div class="col-lg-9">
