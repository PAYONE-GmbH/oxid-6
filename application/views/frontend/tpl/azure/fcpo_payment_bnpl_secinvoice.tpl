    ...
    <dd class="[{if $oView->getCheckedPaymentId() == $paymentmethod->oxpayments__oxid->value}]activePayment[{/if}]">
        ...
        [{if $oView->fcpoBNPLShowBirthdate()}]
            <li>
                ...
                [{/if}]
                &nbsp;
                <select aria-label="[{oxmultilang ident="FCPO_DAY"}]" style="width:15%" name="dynvalue[fcpopl_secinvoice_birthdate_day]">
                ...
                &nbsp;
                <select aria-label="[{oxmultilang ident="FCPO_MONTH"}]" style="width:15%" name="dynvalue[fcpopl_secinvoice_birthdate_month]">
                ...
                &nbsp;
                <select aria-label="[{oxmultilang ident="FCPO_YEAR"}]" style="width:15%" name="dynvalue[fcpopl_secinvoice_birthdate_year]">
        ...
        [{if $oView->fcpoIsB2BPov()}]
            ...
            <li>
                <label for="fcpopl_secinvoice_ustid" class="control-label col-lg-3" style="word-break: break-word">[{oxmultilang ident="FCPO_BNPL_USTID"}]:</label>
                <div class="col-lg-7">
