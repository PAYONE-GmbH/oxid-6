<dl>
    ...
    <dd class="[{if $oView->getCheckedPaymentId() == $paymentmethod->oxpayments__oxid->value}]activePayment[{/if}]">
        ...
        <ul class="form fcpo_elv_form">
            ...
            <li>
                <label for="fcpo_elv_country">[{oxmultilang ident="FCPO_BANK_COUNTRY"}]:</label>
                <select id="fcpo_elv_country" name="dynvalue[fcpo_elv_country]" onchange="fcCheckDebitCountry(this);return false;">
            ...
            <li>
                <label for="fcpo_elv_iban">[{oxmultilang ident="FCPO_BANK_IBAN"}]:</label>
                <input id="fcpo_elv_iban" placeholder="[{oxmultilang ident="FCPO_BANK_IBAN"}]" autocomplete="off" type="text" size="20" maxlength="64" name="dynvalue[fcpo_elv_iban]" value="[{$dynvalue.fcpo_elv_iban}]" onkeyup="fcHandleDebitInputs('[{$oView->fcpoGetBICMandatory()}]]');return false;">
            ...
            [{if $oView->getConfigParam('blFCPODebitBICMandatory')}]
                <li>
                    <label for="fcpo_elv_bic">[{oxmultilang ident="FCPO_BANK_BIC"}]:</label>
                    <input id="fcpo_elv_bic" placeholder="[{oxmultilang ident="FCPO_BANK_BIC"}]" autocomplete="off" type="text" size="20" maxlength="64" name="dynvalue[fcpo_elv_bic]" value="[{$dynvalue.fcpo_elv_bic}]" onkeyup="fcHandleDebitInputs('[{$oView->fcpoGetBICMandatory()}]]');return false;">
