                ...
                <div class="content">
                    ...
                    <p id="payolution_installment_overview_headline" class="payolution_installment_box_body">
                        ...
                        <ul class="form fcpo_payolution_installment_form">
                            ...
                            <li>
                                <label for="fcpo_payolution_installment_accountholder">[{oxmultilang ident="FCPO_PAYOLUTION_ACCOUNTHOLDER"}]:</label>
                            ...
                            <li>
                                <label for="fcpo_payolution_installment_iban">[{oxmultilang ident="FCPO_BANK_IBAN"}]:</label>
                            ...
                            <li>
                                <label for="fcpo_payolution_installment_bic">[{oxmultilang ident="FCPO_BANK_BIC"}]:</label>
