    ...
    <dd class="[{if $oView->getCheckedPaymentId() == $paymentmethod->oxpayments__oxid->value}]activePayment[{/if}]">
        ...
        [{else}]
            ...
            <div class="form-group">
                ...
                <div class="col-lg-9">
                    <select aria-label="[{oxmultilang ident="FCPO_DAY"}]" id="fcpopl_secinstallment_birthdate_day" name="dynvalue[fcpopl_secinstallment_birthdate_day]">
            ...
            <div class="form-group">
                <label for="fcpopl_secinstallment_fon" id="fcpopl_secinstallment_fon_label" class="req control-label col-lg-3">[{oxmultilang ident="FCPO_BNPL_FON"}]:</label>
                <div class="col-lg-9">
            ...
            <div class="form-group">
                <label for="fcpopl_secinstallment_iban" id="fcpopl_secinstallment_iban_label" class="req control-label col-lg-3">[{oxmultilang ident="FCPO_BANK_IBAN"}]:</label>
                <div class="col-lg-9">
                    <input id="fcpopl_secinstallment_iban" placeholder="[{oxmultilang ident="FCPO_BANK_IBAN"}]" class="form-control js-oxValidate js-oxValidate_notEmpty" type="text" size="20" maxlength="64" name="dynvalue[fcpopl_secinstallment_iban]" value="[{$dynvalue.fcpopl_secinstallment_iban}]" onkeyup="fcHandleDebitInputs();return false;" required="required">
