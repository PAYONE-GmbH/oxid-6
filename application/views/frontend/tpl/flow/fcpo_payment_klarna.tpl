            ...
            [{if $blDisplayCampaignMissing == false}]
                ...
                [{if $oView->fcpoKlarnaIsTelephoneNumberNeeded()}]
                    <div class="form-group fcpo_klv_fon">
                        <label for="fcpo_klv_fon" id="fcpo_klv_fon_label" class="req control-label col-lg-3">[{oxmultilang ident="FCPO_KLV_TELEPHONENUMBER"}]:</label>
                        <div class="col-lg-9">
                ...
                [{if $oView->fcpoKlarnaIsAddressAdditionNeeded()}]
                    <div class="form-group fcpo_klv_addinfo">
                        <label for="fcpo_klv_addinfo" id="fcpo_klv_addinfo_label" class="req control-label col-lg-3">[{oxmultilang ident="FCPO_KLV_ADDINFO"}]:</label>
                        <div class="col-lg-9">
                ...
                [{if $oView->fcpoKlarnaIsDelAddressAdditionNeeded()}]
                    <div class="form-group fcpo_klv_del_addinfo">
                        <label for="fcpo_klv_del_addinfo" id="fcpo_klv_del_addinfo_label" class="req control-label col-lg-3">[{oxmultilang ident="FCPO_KLV_ADDINFO_DEL"}]:</label>
                        <div class="col-lg-9">
                ...
                [{if $oView->fcpoKlarnaIsPersonalIdNeeded()}]
                    <div class="form-group fcpo_klv_personalid">
                        <label for="fcpo_klv_personalid" id="fcpo_klv_personalid_label" class="req control-label col-lg-3">[{oxmultilang ident="FCPO_KLV_PERSONALID"}]:</label>
                        <div class="col-lg-9">
