<dl>
    ...
    <dd class="[{if  $oView->fcpoIsKlarnaCombined($checkedPaymentId)}]activePayment[{/if}]">
        ...
        [{if $oView->fcpoKlarnaIsTelephoneNumberNeeded()}]
            <div class="form-group">
                <label for="fcpo_klarna_telephone" id="fcpo_klarna_telephone_label" class="req control-label col-lg-3">[{oxmultilang ident="FCPO_KLV_TELEPHONENUMBER"}]</label>
                <div class="col-lg-9">
        ...
        [{if $oView->fcpoKlarnaIsPersonalIdNeeded()}]
            <div class="form-group">
                <label for="fcpo_klarna_personalid" id="fcpo_klarna_personalid_label" class="req control-label col-lg-3">[{oxmultilang ident="FCPO_KLV_PERSONALID"}]</label>
                <div class="col-lg-9">
