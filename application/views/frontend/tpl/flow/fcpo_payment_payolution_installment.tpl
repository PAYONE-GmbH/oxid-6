        ...
        <div class="fcRow">
            <div class="fcCol fcCol-1">
                <div class="content">
                    ...
                    <p id="payolution_installment_availibility_body" class="payolution_installment_box_body">
                        <select aria-label="[{oxmultilang ident="FCPO_DAY"}]" name="dynvalue[fcpo_payolution_installment_birthdate_day]">
                        ...
                        &nbsp;
                        <select aria-label="[{oxmultilang ident="FCPO_MONTH"}]" name="dynvalue[fcpo_payolution_installment_birthdate_month]">
                        ...
                        &nbsp;
                        <select aria-label="[{oxmultilang ident="FCPO_YEAR"}]" name="dynvalue[fcpo_payolution_installment_birthdate_year]">
            ...
            <div class="fcCol fcCol-3">
                <div class="content">
                    ...
                    <p id="payolution_installment_overview_headline" class="payolution_installment_box_body">
                        ...
                        <p>
                            <label for="fcpo_payolution_installment_accountholder" id="fcpo_payolution_installment_accountholder_label">[{oxmultilang ident="FCPO_PAYOLUTION_ACCOUNTHOLDER"}]:</label>
                            <input id="fcpo_payolution_installment_accountholder" placeholder="[{oxmultilang ident="FCPO_PAYOLUTION_ACCOUNTHOLDER"}]" autocomplete="off" type="text" size="20" maxlength="64" name="dynvalue[fcpo_payolution_installment_accountholder]" value="[{$dynvalue.fcpo_payolution_installment_accountholder}]" onkeyup="fcHandleDebitInputs();return false;">
                        </p>
                        <p>
                            <label for="fcpo_payolution_installment_iban" id="fcpo_payolution_installment_iban_label">[{oxmultilang ident="FCPO_BANK_IBAN"}]:</label>
                            <input id="fcpo_payolution_installment_iban" placeholder="[{oxmultilang ident="FCPO_BANK_IBAN"}]" autocomplete="off" type="text" size="20" maxlength="64" name="dynvalue[fcpo_payolution_installment_iban]" value="[{$dynvalue.fcpo_payolution_installment_iban}]" onkeyup="fcHandleDebitInputs();return false;">
                        ...
                        <p>
                            <label for="fcpo_payolution_installment_bic" id="fcpo_payolution_installment_bic_label">[{oxmultilang ident="FCPO_BANK_BIC"}]:</label>
                            <input id="fcpo_payolution_installment_bic" placeholder="[{oxmultilang ident="FCPO_BANK_BIC"}]" autocomplete="off" type="text" size="20" maxlength="64" name="dynvalue[fcpo_payolution_installment_bic]" value="[{$dynvalue.fcpo_payolution_installment_bic}]" onkeyup="fcHandleDebitInputs();return false;">
