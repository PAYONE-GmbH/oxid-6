        ...
        <dd class="[{if $oView->getCheckedPaymentId() == $paymentmethod->oxpayments__oxid->value}]activePayment[{/if}]">
            ...
            [{if $oView->fcpoRatePayShowUstid()}]
                <div class="form-group fcporp_installment_ustid">
                    <label for="fcporp_installment_ustid" id="fcporp_installment_ustid_label" class="req control-label col-lg-3">[{oxmultilang ident="FCPO_RATEPAY_USTID"}]</label>
                    <div class="col-lg-9">
            ...
            [{if $oView->fcpoRatePayShowFon()}]
                <div class="form-group fcporp_installment_fon">
                    <label for="fcporp_installment_fon" id="fcporp_installment_fon_label" class="req control-label col-lg-3">[{oxmultilang ident="FCPO_RATEPAY_FON"}]</label>
                    <div class="col-lg-9">
            ...
            [{if (in_array($sSettlementType, array('both', 'debit')))}]
                <div id="fcporp_installment_sepa_container">
                    ...
                    <div class="form-group fcpo_ratepay_installment_iban">
                        <label for="fcporp_installment_iban" id="fcporp_installment_iban_label" class="req control-label col-lg-3">[{oxmultilang ident="FCPO_BANK_IBAN"}]</label>
                        <div class="col-lg-9">
