<dl>
    ...
    <dd class="[{if $oView->getCheckedPaymentId() == $paymentmethod->oxpayments__oxid->value}]activePayment[{/if}]">
        ...
        [{else}]
            ...
            <div class="form-group">
                <label for="fcpo_secinvoice_ustid" id="fcpo_secinvoice_ustid_label" class="req control-label col-lg-3">[{oxmultilang ident="FCPO_SECINVOICE_USTID"}]:</label>
                <div class="col-lg-7">
                    <input id="fcpo_secinvoice_ustid" placeholder="[{oxmultilang ident="FCPO_SECINVOICE_USTID"}]" class="form-control" type="text" size="20" maxlength="64" name="dynvalue[fcpo_secinvoice_ustid]" value="[{$oView->fcpoGetUserValue('oxustid')}]">
                </div>
