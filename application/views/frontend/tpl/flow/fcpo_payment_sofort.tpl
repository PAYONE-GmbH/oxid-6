        ...
        [{if $oView->fcpoGetSofoShowIban()}]
            [{if $oView->fcpoForceDeprecatedBankData()}]
                <div class="form-group" id="fcpo_ou_blz">
                    <label for="fcpo_bank_blz" id="fcpo_ou_blz_label" class="req control-label col-lg-3">[{oxmultilang ident="FCPO_BANK_CODE"}]:</label>
                    <div class="col-lg-9">
                ...
                <div class="form-group" id="fcpo_ou_ktonr" style="display: none;">
                    <label for="fcpo_bank_ktonr" id="fcpo_ou_ktonr_label" class="req control-label col-lg-3">[{oxmultilang ident="FCPO_BANK_ACCOUNT_NUMBER"}]:</label>
                    <div class="col-lg-9">
            ...
            [{else}]
                <div class="form-group" id="fcpo_ou_iban">
                    <label for="fcpo_bank_iban" id="fcpo_ou_iban_label" class="req control-label col-lg-3">[{oxmultilang ident="FCPO_BANK_IBAN"}]:</label>
                    <div class="col-lg-9">
                ...
                <div class="form-group" id="fcpo_ou_bic">
                    <label for="fcpo_bank_bic" id="fcpo_bank_bic_label" class="req control-label col-lg-3">[{oxmultilang ident="FCPO_BANK_BIC"}]:</label>
                    <div class="col-lg-9">
