    ...
    <dl>
        ...
        <dd class="[{if $oView->getCheckedPaymentId() == $paymentmethod->oxpayments__oxid->value}] activePayment[{else}]payment-option[{/if}]">
            ...
            <div class="form-group fcpo_elv_country">
                <label for="fcpo_elv_country" class="req control-label col-lg-3">[{oxmultilang ident="FCPO_BANK_COUNTRY"}]:</label>
                <div class="col-lg-9">
                    <select id="fcpo_elv_country" name="dynvalue[fcpo_elv_country]" onchange="fcCheckDebitCountry(this);return false;" class="form-control" required="required">
            ...
            <div class="form-group fcpo_elv_iban">
                <label for="fcpo_elv_iban" class="req control-label col-lg-3">[{oxmultilang ident="FCPO_BANK_IBAN"}]:</label>
                <div class="col-lg-9">
            ...
            [{if $oView->getConfigParam('blFCPODebitBICMandatory')}]
                <div class="form-group fcpo_elv_bic">
                    <label for="fcpo_elv_bic" class="req control-label col-lg-3">[{oxmultilang ident="FCPO_BANK_BIC"}]:</label>
                    <div class="col-lg-9">
