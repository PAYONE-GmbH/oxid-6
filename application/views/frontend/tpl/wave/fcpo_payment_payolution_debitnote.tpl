    ...
    <dl>
        ...
        <dd class="[{if $oView->getCheckedPaymentId() == $paymentmethod->oxpayments__oxid->value}] activePayment[{else}]payment-option[{/if}]">
            ...
            <div class="form-group fcpo_payolution_debitnote_accountholder">
                <label for="fcpo_payolution_debitnote_accountholder" class="req control-label col-lg-3">[{oxmultilang ident="FCPO_PAYOLUTION_ACCOUNTHOLDER"}]:</label>
                <div class="col-lg-9">
            ...
            <div class="form-group fcpo_payolution_debitnote_iban">
                <label for="fcpo_payolution_debitnote_iban" class="req control-label col-lg-3">[{oxmultilang ident="FCPO_BANK_IBAN"}]:</label>
                <div class="col-lg-9">
            ...
            <div class="form-group fcpo_payolution_debitnote_bic">
                <label for="fcpo_payolution_debitnote_bic" class="req control-label col-lg-3">[{oxmultilang ident="FCPO_BANK_BIC"}]:</label>
                <div class="col-lg-9">
