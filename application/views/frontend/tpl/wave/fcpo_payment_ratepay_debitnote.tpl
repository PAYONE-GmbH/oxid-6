        ...
        <dd class="[{if $oView->getCheckedPaymentId() == $paymentmethod->oxpayments__oxid->value}]activePayment[{else}]payment-option[{/if}]">
            ...
            [{if $oView->fcpoRatePayShowUstid()}]
                <div class="form-group fcporp_debitnote_ustid">
                    <label for="fcporp_debitnote_ustid" class="req control-label col-lg-3">[{oxmultilang ident="FCPO_RATEPAY_USTID"}]</label>
                    <div class="col-lg-9">
            ...
            [{if $oView->fcpoRatePayShowFon()}]
                <div class="form-group fcporp_debitnote_fon">
                    <label for="fcporp_debitnote_fon" class="req control-label col-lg-3">[{oxmultilang ident="FCPO_RATEPAY_FON"}]</label>
                    <div class="col-lg-9">
            ...
            <div class="form-group fcpo_ratepay_debitnote_iban">
                <label for="fcpo_ratepay_debitnote_iban" class="req control-label col-lg-3">[{oxmultilang ident="FCPO_BANK_IBAN"}]</label>
                <div class="col-lg-9">
            ...
            <div class="form-group fcpo_ratepay_debitnote_bic">
                <label for="fcpo_ratepay_debitnote_bic" class="req control-label col-lg-3">[{oxmultilang ident="FCPO_BANK_BIC"}]</label>
                <div class="col-lg-9">
